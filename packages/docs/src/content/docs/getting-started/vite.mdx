---
title: Vite Plugin
description: Use ok-actually as a Vite plugin.
sidebar:
  order: 2
---
...
Tailwind CSS v4 uses OKLCH for its own color utilities, so ok-actually leaves them alone. It only transforms legacy colors in your custom CSS:
...
For Next.js or webpack projects, use the [CLI](/ok-actually/getting-started/cli/) instead.
